...
<html lang="en">
  ...
  <body>
    ...
    <div class="Products mon-man">
      <div class="container">
        <div class="row">
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12">
            <div class="inner-menu">
              <div class="inner-name">Bộ lọc</div>
              <div class="inner-timkiem">
                <input type="text" placeholder="Tìm kiếm món ăn..." />
                <a href="timkiemnangcao-2.html" class="inner-tk"
                  ><i class="fa-solid fa-magnifying-glass"></i
                ></a>
              </div>
              <div class="inner-vung">Loại</div>
              <form action="">
                <ul>
                  <li>
                    <input id="mb-2" type="checkbox" />
                    <label for="mb-2">MÓN CHAY</label>
                  </li>
                  <li>
                    <input id="mb-3" type="checkbox" />
                    <label for="mb-3">MÓN MẶN</label>
                  </li>
                  <li>
                    <input id="mb-4" type="checkbox" />
                    <label for="mb-4">MÓN LẨU</label>
                  </li>
                  <li>
                    <input id="mb-5" type="checkbox" />
                    <label for="mb-5">MÓN ĂN VẶT</label>
                  </li>
                  <li>
                    <input id="mb-6" type="checkbox" />
                    <label for="mb-6">MÓN TRÁNG MIỆNG</label>
                  </li>
                  <li>
                    <input id="mb-7" type="checkbox" />
                    <label for="mb-7">NƯỚC UỐNG</label>
                  </li>
                  <li>
                    <input id="mb-8" type="checkbox" />
                    <label for="mb-8">MÓN KHÁC</label>
                  </li>
                </ul>
              </form>
              <div class="inner-mucgia">Mức giá</div>
              <form action="">
                <ul>
                  <li>
                    <input id="box-1" type="checkbox" />
                    <label for="box-1">Dưới 10.000 ₫</label>
                  </li>
                  <li>
                    <input id="box-2" type="checkbox" />
                    <label for="box-2">10.000 ₫ đến 30.000 ₫</label>
                  </li>
                  <li>
                    <input id="box-3" type="checkbox" />
                    <label for="box-3">30.000 ₫ đến 50.000 ₫</label>
                  </li>
                  <li>
                    <input id="box-4" type="checkbox" />
                    <label for="box-4">Trên 50.000 ₫</label>
                  </li>
                </ul>
              </form>
            </div>
          ...
          <div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12">
            <div class="row">
              <div class="col-xl-12">
                <div class="inner-monman">Kết quả tìm kiếm</div>
              </div>
              <div class="col-xl-12">
                <div class="inner-loc">
                  <span class="inner-sapxep">Sắp xếp:</span>
                  <ul>
                    <li><a href="timkiemnangcao-2.html">Tên A → Z</a></li>
                    <li><a href="timkiemnangcao-2.html">Tên Z → A</a></li>
                    <li><a href="timkiemnangcao-2.html">Giá tăng dần</a></li>
                    <li><a href="timkiemnangcao-2.html">Giá giảm dần</a></li>
                    <select class="nut" name="" id="">
                      <option value="A → Z">Tên A → Z</option>
                      <option value="Z → A">Tên Z → A</option>
                      <option value="High-cost">Giá tăng dần</option>
                      <option value="Low-cost">Giá giảm dần</option>
                    </select>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="inner-item">
                  <a href="chitietsp.html" class="inner-img">
                    <img src="assets/img/products/banhcanhcua.jpg">
                  </a>
                  <div class="inner-info">
                    <div class="inner-ten">Bánh canh cua</div>
                    <div class="inner-gia">52.000 ₫</div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="inner-item">
                  <a href="chitietsp.html" class="inner-img">
                    <img src="assets/img/products/bundaumamtom.webp">
                  </a>
                  <div class="inner-info">
                    <div class="inner-ten">Bún đậu mắm tôm</div>
            ...
            <div class="Pagination">
              <div class="container">
                <ul>
                  ...
                  <li>
                    <a href="timkiemnangcao.html" class="inner-trang"> 2 </a>
                  </li>
                  <li>
                    <a href="timkiemnangcao.html" class="inner-trang"> 3 </a>
                  </li>
                  <li>
                    <a href="timkiemnangcao.html" class="inner-trang"> 4 </a>
                  </li>
                  <li>
                    <a href="timkiemnangcao.html" class="inner-trang"> 5 </a>
                  </li>
                </ul>
              </div>
            </div>
