          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12">
            <div class="inner-menu">
              ...
              <div class="inner-timkiem">
                <input type="text" placeholder="Tìm kiếm món ăn..." />
                <a href="timkiemnangcao-login2.html" class="inner-tk"
                  ><i class="fa-solid fa-magnifying-glass"></i
                ></a>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-xl-12">
                <div class="inner-loc">
                  ...
                  <ul>
                    <li><a href="timkiemnangcao-login2.html">Tên A → Z</a></li>
                    <li><a href="timkiemnangcao-login2.html">Tên Z → A</a></li>
                    <li><a href="timkiemnangcao-login2.html">Giá tăng dần</a></li>
                    <li><a href="timkiemnangcao-login2.html">Giá giảm dần</a></li>
            ...
            <div class="Pagination">
              <div class="container">
                <ul>
                  <li>
                    <a
                      href="timkiemnangcao-login.html"
                  ...
                  <li>
                    <a href="timkiemnangcao-login.html" class="inner-trang">
                      2
                    </a>
                  </li>
                  <li>
