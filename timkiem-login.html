  ...
  <body>
    ...
    <div class="Products">
      <div class="container">
        <div class="row">
          <div class="col-xl-12">
            <div class="inner-title">Kết quả tìm kiếm món ăn</div>
          </div>
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              <a href="chitietsp-login.html" class="inner-img">
                <img src="assets/img/products/banhcuonv2.jpg" />
              </a>
              <div class="inner-info">
                <div class="inner-ten">Bánh cuốn</div>
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              <a href="chitietsp-login.html" class="inner-img">
                <img src="assets/img/products/banhit.webp" />
              </a>
              <div class="inner-info">
                <div class="inner-ten">Bánh ít</div>
                <div class="inner-gia">10.000 ₫</div>
                <a href="chitietsp-login.html" class="inner-muahang">
                  <i class="fa-solid fa-cart-plus"></i> ĐẶT MÓN
                </a>
              </div>
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              <a href="chitietsp-login.html" class="inner-img">
                <img src="assets/img/products/banhbao.jpg" />
              </a>
              <div class="inner-info">
                <div class="inner-ten">Bánh bao</div>
                <div class="inner-gia">20.000 ₫</div>
                <a href="chitietsp-login.html" class="inner-muahang">
                  <i class="fa-solid fa-cart-plus"></i> ĐẶT MÓN
                </a>
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              <a href="chitietsp-login.html" class="inner-img">
                <img src="assets/img/products/banhbeo.png" />
              </a>
              <div class="inner-info">
                <div class="inner-ten">Bánh bèo</div>
                <div class="inner-gia">30.000 ₫</div>
                <a href="chitietsp-login.html" class="inner-muahang">
                  <i class="fa-solid fa-cart-plus"></i> ĐẶT MÓN
                </a>
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              ...
              <div class="inner-info">
                <div class="inner-ten">Bánh bột lọc</div>
                <div class="inner-gia">30.000 ₫</div>
                <a href="chitietsp-login.html" class="inner-muahang">
                  <i class="fa-solid fa-cart-plus"></i> ĐẶT MÓN
                </a>
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              <a href="chitietsp-login.html" class="inner-img">
                <img src="assets/img/products/banhchung.jpg" />
              </a>
              <div class="inner-info">
                <div class="inner-ten">Bánh chưng</div>
                <div class="inner-gia">70.000 ₫</div>
                <a href="chitietsp-login.html" class="inner-muahang">
                  <i class="fa-solid fa-cart-plus"></i> ĐẶT MÓN
                </a>
              </div>
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              <a href="chitietsp-login.html" class="inner-img">
                <img src="assets/img/products/banhdalon.jpg" />
              </a>
              <div class="inner-info">
                <div class="inner-ten">Bánh da lợn</div>
                <div class="inner-gia">8.000 ₫</div>
                <a href="chitietsp-login.html" class="inner-muahang">
                  <i class="fa-solid fa-cart-plus"></i> ĐẶT MÓN
                </a>
              </div>
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              <a href="chitietsp-login.html" class="inner-img">
                <img src="assets/img/products/banhflan.jpg" />
              </a>
              <div class="inner-info">
                <div class="inner-ten">Bánh Flan</div>
                <div class="inner-gia">10.000 ₫</div>
                <a href="chitietsp-login.html" class="inner-muahang">
                  <i class="fa-solid fa-cart-plus"></i> ĐẶT MÓN
                </a>
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              <a href="chitietsp-login.html" class="inner-img">
                <img src="assets/img/products/banhnam.jpg" />
              </a>
              <div class="inner-info">
                <div class="inner-ten">Bánh nậm</div>
                <div class="inner-gia">30.000 ₫</div>
                <a href="chitietsp-login.html" class="inner-muahang">
                  <i class="fa-solid fa-cart-plus"></i> ĐẶT MÓN
                </a>
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
            <div class="inner-item">
              <a href="chitietsp-login.html" class="inner-img">
                <img src="assets/img/products/banhtet.jpg" />
              </a>
              <div class="inner-info">
                <div class="inner-ten">Bánh tét</div>
                <div class="inner-gia">50.000 ₫</div>
                <a href="chitietsp-login.html" class="inner-muahang">
                  <i class="fa-solid fa-cart-plus"></i> ĐẶT MÓN
                </a>
      ...
      >
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="inner-name">Bánh cuốn</div>
              <div class="inner-info">
                <div class="inner-gia">30.000 ₫</div>
                <div class="inner-sl">
              ...
              <p class="inner-desc">
                Bánh cuốn là món ăn truyền thống Việt Nam với bánh mềm mịn, nhân
                thịt băm, mộc nhĩ và hành phi thơm. Khi ăn, bánh cuốn được kèm
                chả lụa, rau sống và nước mắm pha, tạo nên sự kết hợp hoàn hảo
                giữa vị ngọt, mặn và cay. Đây là món ăn nhẹ nhàng, dễ ăn, phù
                hợp cho bữa sáng hoặc trưa.
              </p>
            </div>
            <div class="modal-footer">
              <div class="inner-giaca">
                <div class="inner-chu">Thành tiền</div>
                <div class="inner-so">30.000 ₫</div>
              </div>
    ...
    <div class="Pagination">
      <div class="container">
        <ul>
          <li>
            <a href="timkiem-login.html" class="inner-trang trang-chinh"> 1 </a>
          </li>
          <li>
            <a href="timkiem-login.html" class="inner-trang"> 2 </a>
          </li>
          <li>
            <a href="timkiem-login.html" class="inner-trang"> 3 </a>
          </li>
          <li>
            <a href="timkiem-login.html" class="inner-trang"> 4 </a>
          </li>
          <li>
            <a href="timkiem-login.html" class="inner-trang"> 5 </a>
          </li>
        </ul>
      </div>
    </div>
